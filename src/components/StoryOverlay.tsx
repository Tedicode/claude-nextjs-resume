  ...
  return (
      <AnimatePresence>
        {story && (
            ...
            >
              <BackToResumeButton onClick={onCloseStory} style={{ marginBottom: '1.5rem' }} />
              ...
              {story.visual.type === 'flow' && (() => {
                const flowVisual = story.visual as import('@/data/stories').StoryVisualFlow
                return (
                    <div style={{
                      background: '#f7f5f0',
